...
| 标题栏 | 全宽 48px | 品牌 + 模块名 + 窗口控制（⚙ 已移至左导航栏底部，LED 状态灯已移除） |
| 内容区 | 剩余空间 | 跟随左导航切换模块内容 |
| 左侧面板 | 200px 固定 | 仅 Bot 模块显示，内容区左侧，自动刷新 |
| 控制行 | 右侧面板顶部 | `[AI行为 ▼]  [Agent ▼]  [Open Report]  [AI托管 ▼]`，Chat/Work 共用 |
...
│  └────────────────────────────────────────────────────────┘  │
├──────────────────────────────────────────────────────────────────┤
│ [AI行为 ▼]   [Agent ▼]   [Open Report]   [AI托管 ▼] │  ← 控制行
├──────────────────────────────────────────────────────────────────┤
│ [📎] [🎤] │ 输入消息...                               [▶] │  ← 输入区
└──────────────────────────────────────────────────────────────────┘
```
...
| 控制行 | Agent 行为控制 | `[AI行为 ▼]  [Agent ▼]  [Open Report]  [AI托管 ▼]` |
