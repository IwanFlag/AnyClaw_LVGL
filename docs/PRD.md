...
- 检查项最少包含：Node.js、npm、Network、OpenClaw、Gateway、Hermes、Claude Code CLI。
...
> File 模块的目录语义与 VS Code“打开文件夹/工作区”一致：任一时刻只绑定一个当前工作区根目录，文件搜索与列表仅作用于该目录及其子目录；切换工作区后立即重载。
