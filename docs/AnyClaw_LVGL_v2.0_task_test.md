...
| 编号 | 功能 | PRD 章节 | 状态 |
|------|------|---------|------|
| 1 | 聊天历史持久化（最近 50 条） | 2.2.8 | ❌ 待实施 |
| 2 | 会话管理（列表/切换/新建/删除） | 2.2.9 | ❌ 待实施 |
| 3 | 搜索功能 | 2.2.10 | ❌ 待实施 |
...
| 任务 | 内容 | 优先级 | 状态 |
|------|------|--------|------|
| TASK-023 | 通用控件体系 — src/widgets/ | P1 | ❌ 待实施 |
| TASK-025 | 一键迁移功能 | P1 | ❌ 待实施 |
| TASK-027 | 聊天历史持久化 | P1 | ❌ 待实施 |
| TASK-027 | 会话管理 | P1 | ❌ 待实施 |
...
| 文件 | 内容 |
|------|------|
| aw_common.h | 颜色常量(namespace aw)、间距/圆角宏、aw_make_container/aw_divider_create/aw_vdivider_create 工具函数 |
| aw_button.h | aw_btn_create(PRIMARY/SECONDARY/DANGER/GHOST) — 统一样式按钮 |
...
| TASK-027b | 会话管理（列表/切换/新建/删除） | P1 | ❌ 待实施 |
| TASK-026 | 离线授权 | P2 | ⏸️ 暂不实施 |
