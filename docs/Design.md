...
> 版本：v2.2.2 | 目标用户：大学生 & 职场年轻人 | 更新时间：2026-04-21
...
│    │  │                                                          │  │
│    │  │  ┌─ AI 思考 ──────────────────────────────────────┐   │  │
│    │  │  │ 用户查询天气，需要调用搜索工具获取数据...       │   │  │ ← 思考（折叠）
│    │  │  └──────────────────────────────────────────────────┘   │  │
│    │  │                                                          │  │
│    │  │  ┌─ terminal ───────────────────────────────────────┐   │  │
│    │  │  │ $ curl weather-api...                           │   │  │ ← 文件输出
...
**右侧区域结构：** 控制行 → 输出区 → 输入区（与 Chat 完全相同）
...
Chat 和 Work 模式的输入区完全相同，区别仅在于输出区。控制行位于左侧面板顶部：
...
```
  ...
  控制行: Agent下拉 / Open Report 按钮 / AI行为下拉
