// Generate font with full CJK range
...
// Full CJK Unified Ideographs + common ranges
const cmd = `npx lv_font_conv --font "${FONT_TTF}" --format lvgl --size 16 --bpp 4 --no-compress --no-prefilter --force-fast-kern-format -r 0x20-0x7E -r 0x3000-0x303F -r 0xFF00-0xFFEF -r 0x4E00-0x9FFF --lv-include lvgl/lvgl.h --lv-font-name lv_font_mshy_16 -o "${OUTPUT}"`;

console.log('Running font generation with full CJK range 0x4E00-0x9FFF...');
try {
