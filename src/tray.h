...
/* Tray icon color states — 四色统一规范 */
enum class TrayState {
    White,      /* 空闲 / Idle — 已连接，无活跃任务 */
    Yellow,     /* 检测中 / Checking */
    Green,      /* 运行中 / Running */
    Red         /* 异常 / Error */
};
...
#define IDM_START_STOP      1007
#define IDM_REFRESH_STATUS  1008
#define IDM_ALWAYS_TOP      1009
...
/* Request app to quit (called from LVGL exit dialog callback) */
