...
static lv_text_flag_t get_label_flags(lv_label_t * label)
{
    ...
    /* AnyClaw: Always allow breaking between any characters for proper CJK wrapping.
     * Without this, CJK text (no spaces between characters) wraps as one giant "word". */
